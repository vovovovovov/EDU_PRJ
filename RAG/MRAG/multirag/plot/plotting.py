...
def plot_absolute_retrieval_improvement_box(
    ...
    """
    Box Plots - Absolute app001 Improvement
    ...
    for measure, background in zip(measures, backgrounds):
        ...
        plt.ylabel("app001 Success Ratio" if visible["y_label"] else None)
...
def plot_absolute_retrieval_improvement_hist(
    ...
    """
    Histogram - Absolute app001 Improvement
    ...
    for measure, background in zip(measures, backgrounds):
        ...
        plt.xlabel("app001 Success Ratio" if visible["x_label"] else None)
...
def plot_relative_retrieval_improvement_box(
    ...
    """
    Box Plots - Relative app001 Improvement
...
def plot_relative_baselines_low_cost(
    ...
    """
    Box Plots - Relative app001 Improvement - Baselines
...
def plot_relative_retrieval_improvement_line(
    ...
    """
    Line Plots - Relative app001 Improvement
...
def plot_split_rag_voting_strategies(
    ...
    """
    Line Plots - Relative app001 Improvement - Split RAG Voting Strategies
